...
# NOTE: 本番環境ではFalseにして(多分falseにすると開発サーバが起動されないので本番環境でfalseにしないといけない)
DEBUG = False
...
STATIC_URL = 'static/'
# STATICFILES_DIRS にはアプリケーションごとの静的ファイルが格納されているディレクトリを指定します
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'blog/static'),
]

# STATIC_ROOT には collectstatic コマンドによって収集された静的ファイルが格納されるディレクトリを指定します
